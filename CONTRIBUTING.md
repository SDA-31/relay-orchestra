...
3. Preserve explicit one-shot auto-deactivation, the explicit live-session lifecycle, shared-tree default, explicit worktree consent, and no skill-level agent cap.
